      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp}>
            ...
            <h2 className="text-4xl font-extrabold mb-5 tracking-tight text-slate-900">Ogni organizzatore conosce<br />questo scenario</h2>
            <p className="text-slate-500 text-lg leading-relaxed mb-14 max-w-2xl mx-auto">Hai passato mesi a organizzare la gara. Il regolamento è online. Eppure i messaggi continuano ad arrivare — sempre le stesse domande, a qualsiasi ora, da ogni canale.</p>
          </motion.div>
          <motion.div className="grid md:grid-cols-3 gap-6" variants={stagger} initial="hidden" whileInView="visible" viewport={vp}>
            {[
              { icon: "📱", title: "WhatsApp, email e social", desc: "Domande da ogni canale, a ogni ora del giorno e della notte." },
              { icon: "🔁", title: "Sempre le stesse 10 domande", desc: "Orari, parcheggi, ritiro pettorali, rimborsi. Ogni volta, da capo." },
              { icon: "😴", title: "Di notte e nei weekend", desc: "I partecipanti chiedono quando tu non puoi rispondere. Repliq sì." },
            ].map((item, i) => (
              <motion.div key={i} variants={fadeInUp} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
          ...
          {/* Numeri */}
          <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16" variants={stagger} initial="hidden" whileInView="visible" viewport={vp}>
            {[
              { number: "8+ ore", label: "perse per evento a rispondere messaggi" },
              { number: "80%", label: "delle domande sono sempre le stesse 10" },
              { number: "200+", label: "messaggi prima di ogni gara" },
              { number: "0 min", label: "di attesa con Repliq attivo" },
            ].map((s, i) => (
              <motion.div key={i} variants={fadeInUp}>
                <div className="text-4xl font-extrabold mb-1 text-blue-600">{s.number}</div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp}>
            ...
            <div className="flex flex-col gap-3">
              {["Domanda senza risposta → ticket automatico", "Email immediata all'organizzatore", "Risposta dal pannello in un click", "Email automatica al partecipante", "Storico completo di tutte le richieste"].map((step, i) => (
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp} className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
            <div className="flex items-center gap-2 mb-5">
              <div className="w-3 h-3 rounded-full bg-red-400"></div><div className="w-3 h-3 rounded-full bg-yellow-400"></div><div className="w-3 h-3 rounded-full bg-emerald-400"></div>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                { q: "Assistenza medica al km 15?", status: "Aperto", color: "text-red-600 bg-red-50 border-red-100" },
              ].map((t, i) => (
                <div key={i} className="bg-white rounded-xl p-4 flex items-center justify-between border border-slate-100 shadow-sm">
                  <span className="text-sm text-slate-700 font-medium">{t.q}</span>
                  <span className={`text-xs px-2.5 py-1 rounded-full font-semibold border ${t.color}`}>{t.status}</span>
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp}>
            ...
            <h2 className="text-4xl font-extrabold mb-4 tracking-tight text-slate-900">Non è un chatbot qualsiasi.<br /><span className="font-serif-italic text-blue-600">È RAG.</span></h2>
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={i} className="flex items-start gap-4 bg-white rounded-xl p-4 border border-slate-100 shadow-sm">
                  ...
                  <div><p className="font-bold text-sm text-slate-900">{item.title}</p><p className="text-slate-500 text-sm mt-0.5">{item.desc}</p></div>
                </div>
              ))}
            </div>
          </motion.div>
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp} className="relative">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp}>
            ...
            <h2 className="text-4xl font-extrabold tracking-tight mb-4 text-slate-900">Capisci cosa non funziona.<br /><span className="font-serif-italic text-blue-600">Prima della gara.</span></h2>
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">La dashboard distingue tra <strong className="text-slate-700">lacune nel regolamento</strong> e <strong className="text-slate-700">domande frequenti</strong> — due problemi diversi, due soluzioni diverse.</p>
          </motion.div>
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={vp} className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden max-w-3xl mx-auto">
                ...
                <div>
                  ...
                  {[
                    ...
                    <div key={i} className="mb-2.5">
                      <div className="flex justify-between text-xs mb-1"><span className="text-slate-700 font-medium">{item.q}</span><span className="text-slate-400">{item.n}x</span></div>
                      <div className="h-2 bg-slate-100 rounded-full"><div className={`h-2 ${item.c} rounded-full`} style={{ width: `${item.pct}%` }}/></div>
                    </div>
                  ))}
                </div>
                <div>
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    {[
                      ...
                      <div key={i} className={`flex items-center justify-between text-xs rounded-lg px-3 py-2 border ${item.type === "gap" ? "bg-red-50 border-red-100" : "bg-violet-50 border-violet-100"} text-slate-700`}>
                        <span>{item.q}</span>
                  ...
                  <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-3">
                    ...
                    <div className="text-xs text-emerald-600 leading-relaxed">Ogni edizione il chatbot risponde a più domande in autonomia. Meno ticket, meno messaggi, organizzazione più fluida.</div>
                  </div>
                </div>
              </div>
            </div>
