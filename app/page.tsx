  ...
  return (
    <main className="bg-white text-slate-900 font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-0 px-6 overflow-hidden min-h-screen flex flex-col items-center">
        ...
        {/* Content */}
        <motion.div
          className="relative text-center max-w-4xl mx-auto pt-10"
          variants={stagger}
          initial="hidden"
          animate="visible"
        >
          {/* Badge */}
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm border border-slate-200 text-slate-600 text-xs font-semibold px-4 py-2 rounded-full mb-10 shadow-sm">
          ...
          <motion.p variants={fadeInUp} className="text-lg text-slate-500 mb-10 max-w-lg mx-auto leading-relaxed">
          ...
          <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-3 mb-5">
          ...
          <motion.div variants={fadeIn} className="flex items-center justify-center gap-5 text-sm text-slate-400 mb-16">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        >
          ...
          <motion.a
            ...
            className="inline-block bg-blue-600 text-white px-10 py-4 rounded-full font-extrabold text-lg hover:bg-blue-700 transition-colors shadow-xl shadow-blue-200"
